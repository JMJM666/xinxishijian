<template>
  <div>
    ...
    <el-dialog title="心理医生信息" v-model="data.formVisible" width="40%" destroy-on-close>
      <el-form ref="form" :model="data.form" label-width="70px" style="padding: 20px">
        ...
        <el-form-item prop="seniority" label="工龄">
         <el-input v-model="data.form.seniority" placeholder="请输入工龄"></el-input>
         </el-form-item>
        ...
        <el-form-item prop="certificate" label="资格证">
          <el-upload
              ...
              list-type="picture"
              >
            <el-button type="primary">点击上传资格证</el-button>
          </el-upload>
        </el-form-item>
